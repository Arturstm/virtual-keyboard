...
} else if (value.classList.contains('keyboardkey') && currentLanguage === false && shiftOn === false) {
        value = value.children[1].children[0].textContent
} else if (value.classList.contains('keyboardkey') && currentLanguage === false && shiftOn === true) {
        value = value.children[1].children[1].textContent
} else if (value.classList.contains('keyboardkey') && currentLanguage === true && shiftOn === false) {
        value = value.children[0].children[0].textContent
